...
class ApertureCorrect:
    ...
    def __init__(self, outputDate, date, totalAperture, varAperture):
    ...
    def GetCorrection(self):
        ...
        filename = "../../standards/" + self.outputDate + "/aperture_corrections.dat"
...
if __name__ == "__main__":
    ...
    for date in obs:
        ApertureCorrect(date[0], date[1], date[2], date[3]).GetCorrection()
